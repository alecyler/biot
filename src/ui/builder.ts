...
function starterBlueprints(): FavoriteBlueprint[] {
  ...
  return [
    bp("Biot-7 Classic Flower", [
      makeRootSegment(),
      { id: "seg-1", parentId: "root", type: "photo", angle: -2.15, jointOffset: 0, length: 18, phase: 0 },
      { id: "seg-2", parentId: "root", type: "photo", angle: -0.75, jointOffset: 0, length: 20, phase: 0 },
      { id: "seg-3", parentId: "root", type: "photo", angle: 0.75, jointOffset: 0, length: 20, phase: 0 },
      { id: "seg-4", parentId: "root", type: "photo", angle: 2.15, jointOffset: 0, length: 18, phase: 0 },
      { id: "seg-5", parentId: "root", type: "reproduction", angle: Math.PI, jointOffset: 0, length: 14, phase: 0 },
    ]),
    bp("Wedge Hunter", [
      makeRootSegment(),
    ...
    bp("Carrion Ripper", [
      makeRootSegment(),
      { id: "seg-1", parentId: "root", type: "predator", angle: 0, jointOffset: 0, length: 19, phase: 0 },
      { id: "seg-2", parentId: "root", type: "poison", angle: -0.95, jointOffset: 0, length: 15, phase: 0 },
      { id: "seg-3", parentId: "root", type: "poison", angle: 0.95, jointOffset: 0, length: 15, phase: 0 },
      { id: "seg-4", parentId: "root", type: "propulsion", angle: -2.35, jointOffset: 0, length: 10, phase: 0 },
      { id: "seg-5", parentId: "root", type: "propulsion", angle: 2.35, jointOffset: 0, length: 10, phase: Math.PI },
      { id: "seg-6", parentId: "root", type: "reproduction", angle: Math.PI, jointOffset: 0, length: 12, phase: 0 },
    ]),
